  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div
        ...
        onClick={onClose}
      ></div>
      <div className="bg-custom-dark rounded-lg p-6 max-w-lg w-full z-50 shadow-lg relative max-h-[45vh] md:max-h-[90vh] overflow-y-auto overflow-x-hidden lg:mt-32">
        <img
          src={project.image}
          alt={project.title}
